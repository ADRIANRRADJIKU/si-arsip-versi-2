...
<body style="background: url(/kantor.webp); background-position: center;">
    <div class="container">
            ...
            <div class="col-lg-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="text-center"><h4>MANAJEMEN ARSIP DIGITAL</h4></div>
                        <hr>
                        <h5 class="mt-4">Login Ke Akun</h5>
                        <form action="{{ Route("account.login.store")}}" method="post">
                            ...
                            <button class="btn btn-primary btn-block mt-3 fw-bold">Login</button>
                        </form>
                    </div>
                </div>
            </div>
